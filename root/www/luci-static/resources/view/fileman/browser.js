...
let contextMenu = document.querySelector('.fileman-context-menu');

if (!contextMenu) {
    contextMenu = E('div', {
        'class': 'fileman-context-menu',
        'hidden': 'hidden'
    });
...
function showContextMenu(x, y, entry) {
    ...
    if (entry) {
        ...
        addItem(_('Refresh'), function() {
            refresh();
        });

        addItem(_('New Folder'));
    }
...
tableBox.addEventListener('contextmenu', function(event) {
